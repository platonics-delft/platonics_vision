...
class GlobalRegistrationOptimizer():
    def __init__(self):
        ...
        self._target_files = [
            ...
            "../data/0_0_0_250.ply",
            "../data/0_0_0_350.ply",
            "../data/0_m25_0_150.ply",
            "../data/0_m25_0_250.ply",
            "../data/m25_m75_0_150.ply",
            "../data/m25_m75_0_250.ply",
            "../data/m25_m75_0_350.ply",
        ]
    ...
    def objective(self, trial: optuna.Trial):
        ...
        for target_file in self._target_files:
            height = target_file.split("_")[-1].split(".")[0]
            print(height)
            target_file = "../data/" + target_file
            source_file = "../data/0_0_0_" + height + ".ply"
            print(target_file)
            print(source_file)
            self.global_registration.source_file = source_file
